...
# COLOCAR NUM ARQUIVO COTACOES.PY
...
def alta_dia(tickers_file):
    ...
    highest_gain_close_price = None  # Adicionando a inicialização do valor
        ...
        try:
            ...
            if stock_data is not None:
                ...
                if highest_gain is None or daily_gain > highest_gain:
                    ...
                    highest_gain_close_price = close_price  # Atualizando o valor do preço de fechamento
        except Exception as e:
            print(f"Erro ao baixar dados para o ticker {ticker}: {e}")
            continue
    # print("maior alta do dia", highest_gain_ticker, ":", highest_gain_close_price)
    return highest_gain_ticker, highest_gain, highest_gain_close_price
        ...
        try:
            ...
            if stock_data is not None:
                ...
                if highest_gain_fii is None or daily_gain_fii > highest_gain_fii:
                    ...
                    highest_gain_close_price_fii = close_price_fii  # Atualizando o valor do preço de fechamento
        except Exception as e:
            print(f"Erro ao baixar dados para o ticker {ticker}: {e}")
            continue

    # print(highest_gain_ticker_fii, highest_gain_fii, close_price_fii)
    return highest_gain_ticker_fii, highest_gain_fii, highest_gain_close_price_fii
